...
bool Shader::BuildUniforms()
{
  ...
  m_specular1 = GetUniformLocation("SpecularProduct[0]");
  success &= CheckUniformLocation(m_specular1, "m_specular");

  m_specular2 = GetUniformLocation("SpecularProduct[1]");
  success &= CheckUniformLocation(m_specular2, "m_specular");

  m_diffuse1 = GetUniformLocation("DiffuseProduct[0]");
  success &= CheckUniformLocation(m_diffuse1, "m_diffuse");

  m_diffuse2 = GetUniformLocation("DiffuseProduct[1]");
  success &= CheckUniformLocation(m_diffuse2, "m_diffuse");

  m_shininess = GetUniformLocation("Shininess");
  success &= CheckUniformLocation(m_shininess, "m_shininess");

  m_lightPosition1 = GetUniformLocation("LightPosition[0]");
  success &= CheckUniformLocation(m_lightPosition1, "m_lightPosition");

  m_lightPosition2 = GetUniformLocation("LightPosition[1]");
  success &= CheckUniformLocation(m_lightPosition2, "m_lightPosition");
