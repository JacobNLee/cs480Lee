...
Window::Window()
{
  ...
  imgui_vars.specular[0] = glm::vec3(0.6);
  imgui_vars.specular[1] = glm::vec3(0.1);
...
void Window::RunMenu()
{
  ...
  {
    ImGui::Begin("Pinball Variables", &value);
    static float f = 0.0f;
...
//    ImGui::ColorEdit3("Specular Brightness 1", (float*)&imgui_vars.specular[0]);
//    ImGui::ColorEdit3("Diffuse Brightness 1", (float*)&imgui_vars.diffuse[0]);
//    ImGui::ColorEdit3("Specular Brightness 2", (float*)&imgui_vars.specular[1]);
//    ImGui::ColorEdit3("Diffuse Brightness 2", (float*)&imgui_vars.diffuse[1]);
//    ImGui::SliderFloat("Cube Shininess", &imgui_vars.shininess, 0.0f, 1.0f);
    ImGui::SliderFloat3("Light Position", imgui_vars.light_pos, 0, 20);
//    ImGui::SliderFloat3("Light Position 2", imgui_vars.light_pos[1], 0, 20);
